...
import com.admaxim.mvc.admaxim.boot.rest.data.DataBuilder;
import com.admaxim.mvc.admaxim.boot.rest.model.Address;
...
@SpringBootTest
public class AdmaximApplicationTests {
    ...
    public void createCustomer() throws Exception {
        ...
        Customer customer = new Customer("Gary", "Steale", LocalDate.of(1984,  3,  8),
                /*DateTime.parse("1984-03-08").toDate()*/
                new Address("Main Street", "Portadown", "Armagh", "BT359JK"));

        ResponseEntity<String> response = template.postForEntity(base.toString(), customer, String.class);
    ...
    private Customer convertJsonToCustomer(String json) throws IOException {
